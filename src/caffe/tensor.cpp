...
template <> void Tensor<int>::AddMulFrom(const Tensor& source, int alpha) {
  NOT_IMPLEMENTED;
  return;
}

template <> void Tensor<unsigned int>::AddMulFrom(const Tensor& source, unsigned int alpha) {
  NOT_IMPLEMENTED;
  return;
}
...
template <> void Tensor<int>::AddMulFromDynamicMode(const Tensor& source, int alpha) {
  NOT_IMPLEMENTED;
  return;
}

template <> void Tensor<unsigned int>::AddMulFromDynamicMode(const Tensor& source, unsigned int alpha) {
  NOT_IMPLEMENTED;
  return;
}
